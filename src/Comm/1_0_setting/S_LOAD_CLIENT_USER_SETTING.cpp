...
void* S_LOAD_CLIENT_USER_SETTING_f(const void** argv)
{
	...
	if (fp) {
		packet* packet_l = new_packet(S_LOAD_CLIENT_USER_SETTING, -1);
		...
		S_LOAD_SETTING_failled(S_LOAD_CLIENT_USER_SETTING, argv);
	return NULL;
}
